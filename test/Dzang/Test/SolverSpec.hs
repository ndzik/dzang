...
testSolver = do
  evalSolver [] `shouldBe` []
  evalSolver [(typevar "a" :-> typevar "a", int :-> int), (typevar "a", typevar "b")] `shouldBe` [(TypeVar "b", int), (TypeVar "a", int)]
  evalSolver [(typevar "a1", typevar "a2" :-> typevar "a4"), (typevar "a4", typevar "a3" :-> typevar "a5")] `shouldBe` [(TypeVar "a1", typevar "a2" :-> (typevar "a3" :-> typevar "a5")), (TypeVar "a4", typevar "a3" :-> typevar "a5")]
...
testComposition = do
  ...
  [(TypeVar "a4", typevar "a3" :-> typevar "a5")]
    ...
    `shouldBe` [(TypeVar "a4", typevar "a3" :-> typevar "a5"), (TypeVar "a1", typevar "a2" :-> (typevar "a3" :-> typevar "a5"))]
  [(TypeVar "a1", typevar "a2" :-> typevar "a4")]
    `compose` [(TypeVar "a4", typevar "a3" :-> typevar "a5")]
    `shouldBe` [(TypeVar "a1", typevar "a2" :-> typevar "a4"), (TypeVar "a4", typevar "a3" :-> typevar "a5")]
